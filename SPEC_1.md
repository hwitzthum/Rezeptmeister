...
| **4** | **D**  | Gesamt-Verifikation & Abnahme         | nein                      | ✅     | 7/7         |
...
- [x] **D.5** Manuelle iPhone-Checkliste: Installieren über „Zum Home-Bildschirm" · Icon prüfen ·
...
- [x] **D.7** _(neu, nach D.5 entstanden)_ **Render-Branch zurückstellen.** Für die Abnahme wurde
