...
/**
 * Einzige Quelle der Wahrheit für alle drei Navigationen:
 * Desktop-Sidebar, mobile Tab-Leiste und das Mehr-Menü.
 *
 * Aus Sidebar.tsx extrahiert (Welle 0 / Stream F). Neue Bereiche werden hier
 * eingetragen — nicht in den einzelnen Navigations-Komponenten.
 */
...
/** Sammel-Einstieg der Tab-Leiste in alle übrigen Bereiche */
...
/** Gruppierte Vollnavigation — Desktop-Sidebar und Mehr-Menü. */
...
/**
 * Mobile Tab-Leiste: Rezepte · Suche · [+] · Einkauf · Mehr.
 *
 * Der CTA in der Mitte öffnet das CreateActionSheet; `href` dient als
 * Rückfallziel, solange kein JavaScript geladen ist.
 */
export const bottomNavItems: NavItem[] = [
  { href: "/rezepte",       label: "Rezepte",  icon: <BookOpenIcon /> },
  { href: "/suche",         label: "Suche",    icon: <SearchIcon /> },
  { href: "/rezepte/neu",   label: "Erfassen", icon: <PlusIcon />, cta: true },
  { href: "/einkaufsliste", label: "Einkauf",  icon: <ShoppingCartIcon /> },
  { href: "/mehr",          label: "Mehr",     icon: <MoreIcon /> },
];
