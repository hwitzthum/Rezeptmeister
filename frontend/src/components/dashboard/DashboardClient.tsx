  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto" data-testid="dashboard">
      ...
      <header className="relative mb-8 animate-fade-in">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-terra-50 via-cream-100 to-gold-50 border border-terra-100/60 p-6 sm:p-8">
          {/* Decorative circle */}
          <div className="absolute -top-12 -right-12 w-40 h-40 rounded-full bg-terra-100/40 blur-2xl pointer-events-none" />
          <div className="absolute -bottom-8 -left-8 w-32 h-32 rounded-full bg-gold-100/50 blur-xl pointer-events-none" />

          <div className="relative">
            <p className="text-xs font-medium uppercase tracking-[0.2em] text-terra-400 mb-2">
              Dein Rezeptmeister
            </p>
            <h1
